...
-->
        ...
        <div class="table-responsive"  >
            <table class="table table-striped table-hover" id="mytable">
                <thead>
                <tr>
                    <th><span class="glyphicon glyphicon-user"></span> <span class="visible-lg">查看</span></th>
                ...
                @unless(!$res)
                    @foreach($res as $vo)
                        <tr>
                            <td><a href="{{ url('manage/detail').'/'.$vo -> id }}" style="font-size:20px;font-weight: 400;color:blue;">查看</a></td>
                            <td>{{$vo -> title }}</td>
