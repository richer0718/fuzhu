    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main" style="height:700px;overflow-y: auto;padding-bottom:100px;">
        <div class="row">
            <form @if(isset($res)) action="{{ url('admin/editNoticeRes') }}" @else action="{{ url('admin/addNoticeRes') }}" @endif   method="post" class="add-article-form" enctype="multipart/form-data">
                <div class="col-md-9" >
                    <h1 class="page-header">@if(isset($res))编辑内容@else发布内容@endif</h1>
                    ...
                    <div class="form-group">
                        <label for="article-content" >内容<a style="color:red;">（建议全屏操作）</a></label>
                ...
                <div class="col-md-3"  >
                    ...
                    <div class="add-article-box">
                        <h2 class="add-article-box-title"><span>置顶</span></h2>
                        <div class="add-article-box-content">
                            <p><label>是否置顶：</label><input type="radio" name="is_top" value="0" checked/>否 <input type="radio" name="is_top" value="1" />是</p>
